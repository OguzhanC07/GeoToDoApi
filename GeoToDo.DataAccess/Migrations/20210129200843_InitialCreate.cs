        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Targets_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubActivities_Activities_ActivtyId",
                        column: x => x.ActivtyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryActivities_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CategoryActivities_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubActivities_ActivtyId",
                table: "SubActivities",
                column: "ActivtyId");

            migrationBuilder.CreateIndex(
                name: "IX_Targets_AppUserId",
                table: "Targets",
                column: "AppUserId");
        }
